...
function runTests() {
  ...
  console.log("✅ Basic Buy & Sell logic passed.");
  ...
  console.assert(lastMetrics2.holdings["TSLA"].shares === 10, "Test 2: Total shares across broker should remain 10");
  console.log("✅ Inter-Broker Transfers logic passed.");
  ...
  console.log("✅ Merger Corporate Action (1:1.5) math passed.");
  ...
  const trades4: Trade[] = [
    ...
    { symbol: "AMZN", rawSymbol: "AMZN", side: "Sell", qty: 1, fillPrice: 100, commission: 0, date: "2023-01-02" }
  ];
  ...
  console.log("✅ Abnormality Auditing (Negative Holdings detected) passed.");

  console.log("=== ALL MATH AND LOGIC TESTS PASSED SUCCESSFULLY ===");
}
