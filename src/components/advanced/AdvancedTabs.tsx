      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        <div style={{ flex: 1, padding: "24px 20px", overflowY: "auto" }}>
          {!selectedFamilyId ? (
            ...
            <>
              {activeTab === "transactions" && <TransactionsTab familyId={selectedFamilyId} userId={selectedUserId} brokerId={selectedBrokerId} trades={trades} setTrades={setTrades} actions={actions} setActions={setActions} setHasUnsavedChanges={setHasUnsavedChanges} hasUnsavedChanges={hasUnsavedChanges} />}
